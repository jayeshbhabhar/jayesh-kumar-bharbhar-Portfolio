...
<head>
    ...
    <title>Home 02 Reeni - Personal Portfolio HTML Template | Freelancer & Developer Portfolio</title>
    <!-- Bootstrap min css -->
...
<body>
    ...
    <div class="d-none d-xl-block">
            ...
            <div class="inner">
                <div class="top-area">
                    <a href="<?= base_url() ?>index.html" class="logo">
                        <img class="logo-dark" src="<?= base_url() ?>assets/images/logo/white-logo-jk.png" alt="Reeni - Personal Portfolio HTML Template for developers and freelancers">
                        <img class="logo-white" src="<?= base_url() ?>assets/images/logo/logo-white.png" alt="Reeni - Personal Portfolio HTML Template for developers and freelancers">
                    </a>
                ...
                <div class="content-wrapper">
                    <div class="image-area-feature">
                        <a href="<?= base_url() ?>index.html">
                            <img src="<?= base_url() ?>assets/images/logo/man.png" alt="personal-logo">
                        </a>
                    </div>
                    ...
                    <div class="short-contact-area">
                        ...
                        <div class="single-contact">
                            ...
                            <div class="information tmp-link-animation">
                                <span>Call Now</span>
                                <a href="<?= base_url() ?>#" class="number">+92 (8800) - 98670</a>
                            </div>
                        </div>
                        ...
                        <div class="single-contact">
                            ...
                            <div class="information tmp-link-animation">
                                <span>Mail Us</span>
                                <a href="<?= base_url() ?>#" class="number">example@info.com</a>
                            </div>
                        </div>
                        <!-- single contact information end -->
                    ...
                    <div class="social-wrapper mt--20">
                        ...
                        <div class="social-link">
                            ...
                            <a href="<?= base_url() ?>#"><i class="fa-brands fa-linkedin-in"></i></a>
                            <a href="<?= base_url() ?>#"><i class="fa-brands fa-twitter"></i></a>
                            <a href="<?= base_url() ?>#"><i class="fa-brands fa-facebook-f"></i></a>
                        </div>
                    </div>
                    <!-- social area end -->
                </div>
        ...
        <a class="overlay_close_side_menu close_side_menu_active" href="<?= base_url() ?>javascript:void(0);"></a>
    </div>
        ...
        <div class="tmp-popup-mobile-menu">
            <div class="inner">
                <div class="header-top">
                    <div class="logo">
                        <a href="<?= base_url() ?>index.html" class="logo-area">
                            <img class="logo-dark" src="<?= base_url() ?>assets/images/logo/white-logo-jk.png" alt="Reeni - Personal Portfolio HTML Template for developers and freelancers">
                            <img class="logo-white" src="<?= base_url() ?>assets/images/logo/logo-white.png" alt="Reeni - Personal Portfolio HTML Template for developers and freelancers">
                        </a>
                ...
                <ul class="tmp-mainmenu">
                    <li>
                        ...
                        <!-- <ul class="submenu">
            <li><a href="<?= base_url() ?>index.html">Home 01</a></li>
            <li><a href="<?= base_url() ?>index-02.html">Home 02</a></li>
            <li><a href="<?= base_url() ?>index-03.html">Home 03</a></li>
            <li><a href="<?= base_url() ?>index-04.html">Home 04</a></li>
            <li><a href="<?= base_url() ?>index-05.html">Home 05</a></li>
            <li><a href="<?= base_url() ?>index-06.html">Home 06</a></li>
            <li><a href="<?= base_url() ?>index-07.html">Home 07</a></li>
            <li><a href="<?= base_url() ?>index-08.html">Home 08</a></li>
            <li><a href="<?= base_url() ?>index-09.html">Home 09</a></li>
            <li><a href="<?= base_url() ?>index-10.html">Home 10</a></li>
            <li><a href="<?= base_url() ?>index-11.html">Home 11</a></li>
            <li><a href="<?= base_url() ?>index-12.html">Home 12</a></li>
            <li><a href="<?= base_url() ?>index-13.html">Home 13</a></li>
        </ul> -->
                    </li>
                    <li>
                    ...
                    <li class="has-dropdown">
                        ...
                        <ul class="submenu">
                            <li><a href="<?= base_url() ?>service.html">Service</a></li>
                            <li><a href="<?= base_url() ?>service-details.html">Service Details</a></li>
                        </ul>
                    </li>
                    <li class="has-dropdown">
                        ...
                        <ul class="submenu">
                            <li><a href="<?= base_url() ?>blog.html">Blog Classic</a></li>
                    ...
                    <li class="has-dropdown">
                        ...
                        <ul class="submenu">
                            <li><a href="<?= base_url() ?>project.html">Project</a></li>
                            <li><a href="<?= base_url() ?>project-details.html">Project Details</a></li>
                        </ul>
                    </li>
                    <li>
    ...
    <div class="rpp-banner-two-area">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="banner-right-content">
                            <div class="main-img">
                                <img class="tmp-scroll-trigger tmp-zoom-in animation-order-1" src="<?= base_url() ?>assets/images/banner/banner-user-image-two.png" alt="banner-img">
                                <h2 class="banner-big-text-1 up-down-2">Ux Designer</h2>
                                <h2 class="banner-big-text-2 up-down">UxI Designer</h2>
                                <div class="benner-two-bg-red-img">
                                    <img src="<?= base_url() ?>assets/images/banner/banner-user-image-two-red-bg.png" alt="red-img">
                                </div>
                                <div class="logo-under-img-wrap">
                                    <div class="logo-under-img">
                                        <img src="<?= base_url() ?>assets/images/banner/logo-under-image.png" alt="logo-under-image">
                                    </div>
                                    <div class="logo-under-img-2">
                                        <img src="<?= base_url() ?>assets/images/banner/logo-under-image-2.png" alt="logo-under-image">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6 order-lg-1 mt--100">
                        <div class="inner">
                            ...
                            <h1 class="title tmp-scroll-trigger tmp-fade-in animation-order-2">
                                Jayesh Kumar Bhabhar, a Full Stuck <br>
                            ...
                            <div class="button-area-banner-two tmp-scroll-trigger tmp-fade-in animation-order-4">
                                ...
                                <a class="tmp-btn hover-icon-reverse radius-round" href="<?= base_url() ?>about.html">
        ...
        <div class="banner-shape-two">
            <img src="<?= base_url() ?>assets/images/banner/banner-shape-two.png" alt="">
        </div>
    </div>
    <!-- tmp banner area end -->
    ...
    <div class="about-content-area">
        <div class="container tmp-section-gap">
            <div class="text-para-doc-wrap">
                <h2 class="text-para-documents tmp-scroll-trigger tmp-fade-in inv-title-animation-wrap animation-order-1">A personal
                ...
                <div class="right-bg-text-para">
                    <img src="<?= base_url() ?>assets/images/banner/right-bg-text-para-doc.png" alt="">
                </div>
                <div class="left-bg-text-para">
                    <img src="<?= base_url() ?>assets/images/banner/left-bg-text-para-doc.png" alt="">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="about-us-section-card row g-5">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="about-us-card tmponhover tmp-scroll-trigger tmp-fade-in animation-order-4">
                                    <div class="card-head">
                                        <div class="logo-img">
                                            <img src="<?= base_url() ?>assets/images/about/logo-1.svg" alt="logo">
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="about-us-card tmponhover tmp-scroll-trigger tmp-fade-in animation-order-5">
                                    <div class="card-head">
                                        <div class="logo-img">
                                            <img src="<?= base_url() ?>assets/images/about/logo-2.svg" alt="logo">
                                        </div>
            ...
            <div class="row g-5">
                    ...
                    <div class="progress-wrapper">
                        <div class="content">
                            <h2 class="custom-title mb--30 tmp-scroll-trigger tmp-fade-in animation-order-1">
                                Design Skill <span><img src="<?= base_url() ?>assets/images/custom-line/custom-line.png" alt="custom-line"></span>
                            </h2>
                ...
                <div class="col-lg-6">
                    <div class="progress-wrapper">
                        <div class="content">
                            <h2 class="custom-title mb--30 tmp-scroll-trigger tmp-fade-in animation-order-1">
                                Development Skill <span><img src="<?= base_url() ?>assets/images/custom-line/custom-line.png" alt="custom-line"></span>
                            </h2>
                            <!-- Start Single Progress Charts -->
                            <div class="progress-charts">
                                <h6 class="heading heading-h6">
                                ...
                                <div class="latest-portfolio-card-style-two image-box-hover tmp-scroll-trigger tmp-fade-in animation-order-1">
                                    <div class="portfoli-card-img">
                                        <div class="img-box v2">
                                            <a class="tmp-scroll-trigger tmp-zoom-in animation-order-1" href="<?= base_url() ?>project-details.html">
                                                <img class="w-100" src="<?= base_url() ?>assets/images/latest-portfolio/portfoli-img-1.jpg" alt="Thumbnail">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="portfolio-card-content-wrap">
                                        <div class="content-left">
                                            <h3 class="portfolio-card-title"><a href="<?= base_url() ?>project-details.html">SAAS website
                                                    design</a></h3>
                                            <div class="tag-items">
                                                <ul>
                                                    <li>
                                                        <a href="<?= base_url() ?>#" class="tag-item">Figma</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?= base_url() ?>#" class="tag-item">Figma</a>
                                                    </li>
                                        ...
                                        <a class="tmp-btn hover-icon-reverse radius-round btn-border btn-md" href="<?= base_url() ?>project-details.html">
                                            <span class="icon-reverse-wrapper">
                            ...
                            <div class="col-lg-6">
                                <div class="latest-portfolio-card-style-two image-box-hover tmp-scroll-trigger tmp-fade-in animation-order-2">
                                    <div class="portfoli-card-img">
                                        <div class="img-box v2">
                                            <a class="tmp-scroll-trigger tmp-zoom-in animation-order-1" href="<?= base_url() ?>project-details.html">
                                                <img class="w-100" src="<?= base_url() ?>assets/images/latest-portfolio/portfoli-img-3.jpg" alt="Thumbnail">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="portfolio-card-content-wrap">
                                        <div class="content-left">
                                            <h3 class="portfolio-card-title"><a href="<?= base_url() ?>project-details.html">Workout App
                                                    design</a></h3>
                                            <div class="tag-items">
                                                <ul>
                                                    <li>
                                                        <a href="<?= base_url() ?>#" class="tag-item">Adobe</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?= base_url() ?>#" class="tag-item">Webflow</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?= base_url() ?>#" class="tag-item">Ai</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="latest-portfolio-card-style-two image-box-hover tmp-scroll-trigger tmp-fade-in animation-order-3">
                                    <div class="portfoli-card-img">
                                        <div class="img-box v2">
                                            <a class="tmp-scroll-trigger tmp-zoom-in animation-order-1" href="<?= base_url() ?>project-details.html">
                                                <img class="w-100" src="<?= base_url() ?>assets/images/latest-portfolio/portfoli-img-4.jpg" alt="Thumbnail">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="portfolio-card-content-wrap">
                                        <div class="content-left">
                                            ...
                                            <div class="tag-items">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="<?= base_url() ?>#" class="tag-item">Framer</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?= base_url() ?>#" class="tag-item">Wordpress</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="latest-portfolio-card-style-two image-box-hover tmp-scroll-trigger tmp-fade-in animation-order-4">
                                    <div class="portfoli-card-img">
                                        <div class="img-box v2">
                                            <a class="tmp-scroll-trigger tmp-zoom-in animation-order-1" href="<?= base_url() ?>project-details.html">
                                                <img class="w-100" src="<?= base_url() ?>assets/images/latest-portfolio/portfoli-img-2.jpg" alt="Thumbnail">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="portfolio-card-content-wrap">
                                        <div class="content-left">
                                            <h3 class="portfolio-card-title"><a href="<?= base_url() ?>project-details.html">Dashboard
                                                    design</a></h3>
                                            <div class="tag-items">
                                                <ul>
                                                    <li>
            ...
            <div class="services-widget v2">
                    ...
                    <div class="my-expertise-card-wrap">
                        <div class="expertise-card-left">
                            <div class="expertise-card-logo">
                                <img src="<?= base_url() ?>assets/images/my-expertise/logo-4.svg" alt="logo">
                            </div>
                ...
                <div class="service-item tmp-scroll-trigger tmp-fade-in animation-order-2">
                    <div class="my-expertise-card-wrap">
                        <div class="expertise-card-left">
                            <div class="expertise-card-logo">
                                <img src="<?= base_url() ?>assets/images/my-expertise/logo-5.svg" alt="logo">
                            </div>
                ...
                <div class="service-item tmp-scroll-trigger tmp-fade-in animation-order-3">
                    <div class="my-expertise-card-wrap">
                        <div class="expertise-card-left">
                            <div class="expertise-card-logo">
                                <img src="<?= base_url() ?>assets/images/my-expertise/logo-6.svg" alt="logo">
                            </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide ">
                        <div class="client-testimonial-card-wrap">
                            <div class="client-card-head">
                                <div class="client-info">
                                    <div class="client-img">
                                        <img src="<?= base_url() ?>assets/images/testimonial/client-img-1.jpg" alt="">
                            ...
                            <div class="quat-logo">
                                <img src="<?= base_url() ?>assets/images/testimonial/quat-logo.svg" alt="quat-logo">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        ...
                        <div class="my-skill-card-style-two row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="my-skill-card tmp-scroll-trigger tmp-fade-in animation-order-1">
                                    <div class="card-icon">
                                        <img src="<?= base_url() ?>assets/images/icons/icon-01.png" alt="my-skill-icon">
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="my-skill-card tmp-scroll-trigger tmp-fade-in animation-order-2">
                                    <div class="card-icon">
                                        <img src="<?= base_url() ?>assets/images/icons/icon-02.png" alt="my-skill-icon">
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="my-skill-card tmp-scroll-trigger tmp-fade-in animation-order-3">
                                    <div class="card-icon">
                                        <img src="<?= base_url() ?>assets/images/icons/icon-03.png" alt="my-skill-icon">
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="my-skill-card tmp-scroll-trigger tmp-fade-in animation-order-4">
                                    <div class="card-icon">
                                        <img src="<?= base_url() ?>assets/images/icons/icon-04.png" alt="my-skill-icon">
                                    </div>
                            ...
                            <ul class="ft-link v2">
                                <li class="tmp-scroll-trigger tmp-fade-in animation-order-1 tmp-link-animation">
                                    ...
                                    <div class="ft-link-wrap">
                                        ...
                                        <a href="<?= base_url() ?>#">nafiz125@gmail.com</a>
                                    </div>
                                </li>
                    ...
                    <div class="blog-card-style-two tmponhover image-box-hover tmp-scroll-trigger tmp-fade-in animation-order-3">
                        <div class="blog-card-img">
                            <div class="img-box">
                                <a href="<?= base_url() ?>blog-details.html">
                                    <img class="w-100" src="<?= base_url() ?>assets/images/blog/blog-img-1.jpg" alt="Blog Thumbnail">
                                </a>
                            </div>
                            <span>12 Feb</span>
                        </div>
                        <div class="blog-content-wrap">
                            <div class="blog-tags">
                                <ul>
                                    <li>
                                        <a href="<?= base_url() ?>#"><i class="fa-regular fa-user"></i>Mesbah</a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url() ?>#"><i class="fa-regular fa-comments"></i>Comments (05)</a>
                                    </li>
                                </ul>
                            </div>
                            <h3 class="blog-title"><a href="<?= base_url() ?>blog-details.html">Inspiring the World, One Project at a
                                    Time for the
                                    man</a></h3>

                            <div class="read-more-btn">
                                <a class="tmp-btn hover-icon-reverse radius-round btn-border btn-md" href="<?= base_url() ?>blog-details.html">
                                    <span class="icon-reverse-wrapper">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="blog-card-style-two tmponhover image-box-hover tmp-scroll-trigger tmp-fade-in animation-order-2">
                        <div class="blog-card-img">
                            <div class="img-box">
                                <a href="<?= base_url() ?>blog-details.html">
                                    <img class="w-100" src="<?= base_url() ?>assets/images/blog/blog-img-2.jpg" alt="Blog Thumbnail">
                                </a>
                            </div>
                            <span>12 Feb</span>
                        </div>
                        <div class="blog-content-wrap">
                            ...
                            <h3 class="blog-title"><a href="<?= base_url() ?>blog-details.html">Let’s bring your ideas to life! Contact me, and let’s</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="blog-card-style-two tmponhover image-box-hover tmp-scroll-trigger tmp-fade-in animation-order-3">
                        <div class="blog-card-img">
                            <div class="img-box">
                                <a href="<?= base_url() ?>blog-details.html">
                                    <img class="w-100" src="<?= base_url() ?>assets/images/blog/blog-img-3.jpg" alt="Blog Thumbnail">
                                </a>
                            </div>
                            <span>12 Feb</span>
                        </div>
                        <div class="blog-content-wrap">
                            ...
                            <h3 class="blog-title"><a href="<?= base_url() ?>blog-details.html">Each one showcases my approach and dedication man</a></h3>
                ...
                <div class="row g-5">
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-footer-wrapper border-right mr--20">
                            <div class="logo">
                                <a href="<?= base_url() ?>index.html">
                                    <img src="<?= base_url() ?>assets/images/logo/white-logo-jk.png" alt="Reeni - Personal Portfolio HTML Template for developers and freelancers">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="quick-link-wrap">
                            ...
                            <ul class="ft-link tmp-scroll-trigger animation-order-1 tmp-link-animation">
                                ...
                                <li>
                                    <a href="<?= base_url() ?>service.html">Service</a>
                                </li>
                                <li>
                                    <a href="<?= base_url() ?>service.html">Contact Us</a>
                                </li>
                                <li>
                                    <a href="<?= base_url() ?>blog.html">Blog Post</a>
                                </li>
                                <li>
                                    <a href="<?= base_url() ?>contact.html">Pricing</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-footer-wrapper contact-wrap">
                            ...
                            <ul class="ft-link tmp-scroll-trigger animation-order-1 tmp-link-animation">
                                <li><span class="ft-icon"><i class="fa-solid fa-phone"></i></span><a href="<?= base_url() ?>#">017345 678
                                        9101</a></li>
                                <li><span class="ft-icon"><i class="fa-solid fa-location-dot"></i></span>Cumilla,Bangladesh</li>
                                <li><span class="ft-icon"><i class="fa-solid fa-envelope"></i></span><a href="<?= base_url() ?>#">abcd@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="newslatter tmp-scroll-trigger animation-order-1">
                            ...
                            <form action="#" class="newsletter-form-1">
                                ...
                                <span>
                                    <a href="<?= base_url() ?>#" class="form-icon"><i class="fa-solid fa-arrow-right"></i></a>
                                </span>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="main-wrapper tmp-scroll-trigger animation-order-1">
                        ...
                        <ul class="tmp-link-animation">
                            <li><a href="<?= base_url() ?>#">Trams & Condition</a></li>
    ...
    <div class="scrollToTop" style="display: block;">
        ...
        <div class="water" style="transform: translate(0px, 87%);">
            <svg viewBox="0 0 560 20" class="water_wave water_wave_back">
                <use xlink:href="<?= base_url() ?>#wave"></use>
            </svg>
        ...
        <div class="wrapper">
            <div class="tmp-modal-inner">
                ...
                <ul class="popuptab-area nav nav-tabs" id="popuptab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active demo-dark" id="demodark-tab" data-bs-toggle="tab" href="<?= base_url() ?>#demodark" role="tab" aria-controls="demodark" aria-selected="true">Dark Demo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link demo-light" id="demolight-tab" data-bs-toggle="tab" href="<?= base_url() ?>#demolight" role="tab" aria-controls="demolight" aria-selected="false">Light Demo</a>
                    </li>
                </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-1.png" alt="Personal Portfolio">
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index.html">Main Demo</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-02.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-2.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-02.html">Demo 02</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-03.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-3.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-03.html">Demo 03</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-04.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-4.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-04.html">Demo 04</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-05.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-5.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-05.html">Demo 05</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-06.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-6.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-06.html">Demo 06</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-07.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-7.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-07.html">Demo 07</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-08.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-8.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-08.html">Demo 08</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-09.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-9.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-09.html">Demo 09</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-10.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-10.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-10.html">Demo 10</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-11.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-11.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-11.html">Demo 11</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-12.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-12.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-12.html">Demo 12</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-13.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-13.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-13.html">Demo 13</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-14.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-14.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-14.html">Demo 14</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-15.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-15.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-15.html">Demo 15</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-16.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-16.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-16.html">Demo 16</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-17.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-17.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-17.html">Demo 17</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-18.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-18.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-18.html">Demo 18</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-19.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-19.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-19.html">Demo 19</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-20.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-20.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-20.html">Demo 20</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-21.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-21.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-21.html">Demo 21</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-22.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-22.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-22.html">Demo 22</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>#">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/coming-soon.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>#">Demo 23</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>#">Demo 24</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-1-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-white.html">Main Demo</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-02-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-2-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-02-white.html">Demo 02</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-03-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-3-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-03-white.html">Demo 03</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-04-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-4-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-04-white.html">Demo 04</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-05-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-5-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-05-white.html">Demo 05</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-06-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-6-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-06-white.html">Demo 06</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-07-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-7-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-07-white.html">Demo 07</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-08-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-8-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-08-white.html">Demo 08</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-09-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-9-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-09-white.html">Demo 09</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-10-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-10-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-10-white.html">Demo 10</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-11-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-11-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-11-white.html">Demo 11</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-12-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-12-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-12-white.html">Demo 12</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-13-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-13-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-13-white.html">Demo 13</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-14-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-14-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-14-white.html">Demo 14</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-15-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-15-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-15-white.html">Demo 15</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-16-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-16-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-16-white.html">Demo 16</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-17-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-17-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-17-white.html">Demo 17</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-18-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-18-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-18-white.html">Demo 18</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-19-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-19-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-19-white.html">Demo 19</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-20-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-20-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-20-white.html">Demo 20</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-21-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-21-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-21-white.html">Demo 21</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>index-22-white.html">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/home-22-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
                                            ...
                                            <div class="inner">
                                                <h3 class="title"><a href="<?= base_url() ?>index-22-white.html">Demo 22</a></h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="single-demo">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="<?= base_url() ?>#">
                                                    <img class="w-100" src="<?= base_url() ?>assets/images/demo/coming-soon-white.png" alt="Personal Portfolio">
                                                    <span class="overlay-content">
                                                        <span class="overlay-text">View Demo <i
                                                                class="feather-external-link"></i></span>
                                                    </span>
    ...
    <script src="<?= base_url() ?>assets/js/plugins/odometer.js"></script>
    <script src="<?= base_url() ?>assets/js/vendor/appear.js"></script>


    <script src="<?= base_url() ?>assets/js/vendor/jquery-one-page-nav.js"></script>
    <script src="<?= base_url() ?>assets/js/plugins/swiper.js"></script>

    <script src="<?= base_url() ?>assets/js/plugins/gsap.js"></script>
    <script src="<?= base_url() ?>assets/js/plugins/splittext.js"></script>
    <script src="<?= base_url() ?>assets/js/plugins/scrolltigger.js"></script>
    <script src="<?= base_url() ?>assets/js/plugins/scrolltoplugins.js"></script>
    ...
    <script src="<?= base_url() ?>assets/js/plugins/isotop.js"></script>
    <script src="<?= base_url() ?>assets/js/plugins/animation.js"></script>
    <script src="<?= base_url() ?>assets/js/plugins/contact.form.js"></script>
    <script src="<?= base_url() ?>assets/js/vendor/backtop.js"></script>
    <script src="<?= base_url() ?>assets/js/plugins/text-type.js"></script>
    <!-- custom Js -->
